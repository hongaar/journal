...
const outPath = path.join(webRoot, "src", "plugins", "generated-manifests.ts");
const webPkgJsonPath = path.join(webRoot, "package.json");
...
const source = `// Auto-generated by apps/web/scripts/generate-plugin-registry.mjs
